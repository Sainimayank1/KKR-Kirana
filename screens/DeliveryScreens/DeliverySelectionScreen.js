    ...
    <View className="flex-1 bg-white relative">
      ...
      <View className="gap-y-2 pt-5">
        ...
        <View className="flex-row px-4 ">
          <TouchableOpacity
            onPress={()=>setSelectMode((state)=>state == "Shop" ? "Home" : "Shop" )}
      ...
      <TouchableOpacity className="absolute bottom-0 w-full p-4 flex items-center justify-center" style={{backgroundColor:colors.orange}}>
            <View>
